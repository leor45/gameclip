...
el escritorio, espejo funcional de **las apps de clips comerciales** con sus funciones premium incluidas. El usuario
juega con la app corriendo en segundo plano y, con una tecla rápida, guarda retroactivamente los
últimos segundos de juego (clip retroactivo), inicia grabaciones manuales o graba el escritorio
completo.
...
**Incluido — paridad con las apps de clips premium:**
...
- Editor de clips: recorte, y progresivamente el resto de herramientas del editor de las apps de clips.
...
3. **Paridad con las apps de clips.** Ante una duda de diseño o comportamiento, la referencia es cómo lo hace
   las apps de clips comerciales en su plan premium.
